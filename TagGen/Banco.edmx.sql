...
-- --------------------------------------------------
-- Date Created: 08/13/2016 19:49:36
...
-- Creating table 'tERCEIRIZASet'
CREATE TABLE [dbo].[tERCEIRIZASet] (
    [Id] int IDENTITY(1,1) NOT NULL
);
GO
...
-- Creating primary key on [Id] in table 'tERCEIRIZASet'
ALTER TABLE [dbo].[tERCEIRIZASet]
ADD CONSTRAINT [PK_tERCEIRIZASet]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
